# set folders
$downloadfolder = "C:\Users\Michael\Documents\exceltest"         # folder where the .xls files are
$uploadfolder   = "C:\Users\Michael\Documents\exceltest\new"  # folder that uploads the .xlsx files
$backupfolder   = "C:\Users\Michael\Documents\exceltest\old"  # folder that has .xls files as backup
